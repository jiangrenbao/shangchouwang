...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        // 获取总记录数
        var totalRecord = ${requestScope.adminInfo.total};
        ...
        var properties = {
            ...
            items_per_page: ${requestScope.adminInfo.pageSize},	// 每页要显示的数据的数量
            current_page: ${requestScope.adminInfo.pageNum - 1},	// Pagination内部使用pageIndex来管理页码，pageIndex从0开始，pageNum从1开始，所以要减一
